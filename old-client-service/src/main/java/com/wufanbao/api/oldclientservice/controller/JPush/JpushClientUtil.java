package com.wufanbao.api.oldclientservice.controller.JPush;
...
public class JpushClientUtil {
    private static final String appkey = "1d846ee3dfdf68c01ce2fe51";
    private static final String masterSecret = "0606d2fc182a9e498d6283ae";
     ...
     * @return 0推送失败，1推送成功
     */
    public static int sendToRegistrationId(String registrationId, String notification_title, String extrasparam) {
        int result = 0;
        String msg_title = "";
        String msg_content = "";
        try {
        ...
        return PushPayload.newBuilder()
                ...
                .setNotification(Notification.newBuilder()
                        ...
                        .addPlatformNotification(IosNotification.newBuilder()
                                ...
                                .setSound("sound.caf")
                                //此字段为透传字段，不会显示在通知栏。用户可以通过此字段来做一些定制需求，如特定的key传要指定跳转的页面（value）
                                .addExtra("type", extrasparam).setContentAvailable(true).build()).build())
                .setMessage(Message.newBuilder()
                        .setMsgContent(msg_content)
                        .setTitle(msg_title)
